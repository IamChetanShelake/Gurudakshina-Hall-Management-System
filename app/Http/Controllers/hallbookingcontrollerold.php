...
class HallBokkingController extends Controller
{
    ...
    public function view($id){
     ...
     public function confirmBooking($id, Request $request)
     {
        ...
        //         $service->save();
        //         //hey grok bro i have to call new sendwhatsappmessagetovedors when admin approves the request 
        ...
        public function updateStatus(Request $request)
            {
                ...
                if ($service) {
                    $service->status = $status;
                    $service->save();
                    // Call sendWhatsappMessageToVendors when the status is approved
                    if ($status === 'approved') {
        ...
        //here that sendwhatsappmessagetovedors function is need to be come , you have to write here that function 
